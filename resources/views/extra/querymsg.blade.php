<div class="incoming_msg">
  ...
  <div class="received_msg">
    <div class="received_withd_msg">
      ...
      <table class="table pt-2 pb-2">
        <tbody>
          @foreach ($datas as $data)
            <tr>
              <td><img src="{{asset($data->vendors->profile_img or $data->product->image)}}" alt="Image" style="width:4rem;"></td>
      ...
      <p>Our team will call you shortly regarding the order for confirmation. You can check the status of your order anytime in “query list” under “My Account”. If you feel like there should be any change in the cart do contact us immediately.</p>
      ...
      <p>With regards,<br/> Ayojok team </b> +880-1959 555 666</p>
        <span class="time_date"> {{$data->created_at->format('g:i A')}} | {{$data->created_at->format('M d')}}</span>
      </div>
    </div>
  </div>
